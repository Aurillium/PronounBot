...
CREATE TABLE IF NOT EXISTS UserSets (
	ID		INTEGER		NOT NULL AUTO_INCREMENT,
	UserID	BINARY(32)	NOT NULL UNIQUE,
	SetID	INTEGER		NOT NULL,
	PRIMARY KEY(ID)
);
...
CREATE TABLE IF NOT EXISTS Servers (
	ID			BINARY(32)	NOT NULL UNIQUE,	-- Store identifiers in a hash so even if someone manages an SQL injection they won't be able identify the owner
	Announce	BIGINT,
	PRIMARY KEY(ID)
);
/*CREATE TABLE IF NOT EXISTS Users (
	ID		BINARY(32)	NOT NULL UNIQUE,
	PRIMARY KEY(ID)
)*/