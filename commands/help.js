...
const helpEmbed = new MessageEmbed()
	...
	.addField("How to use it", "Just use one of the 'try' commands to test out a set of pronouns. The command should tell you what you need, but in case you want a description of each command and what it does, type `/commands` for details on all of them. Alternatively, use:")
	.addField("@mention Command", "Pronoun Bot has a feature that allows you to @mention the bot (start your message with <@" + client_id + ">) to run a command that gives you much greater flexibility than the others, but you might need more help to use it. You can learn more about this with `/mention-help`")
