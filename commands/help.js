...
const helpEmbed = new MessageEmbed()
	...
	.addField("How to use it", "Use the `/try` command to try a pronoun set in the form of 'subjective/objective/possessive/possessive/reflexive' or 'subjective/objective/possessive/reflexive', or enter a pronoun for each type, then add your name. The bot will give you back some example sentences using the name and pronouns you choose!")
