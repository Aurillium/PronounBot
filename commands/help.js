...
const helpEmbed = new MessageEmbed()
	...
	.addField("How to use it", "Just use one of the 'try' commands to test out a set of pronouns. The command should tell you what you need, but in case you want a description of each command and what it does, type `/commands` for details on all of them.")
